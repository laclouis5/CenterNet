...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black',
    ...
    elif dataset == 'plant_db':
      self.names = plant_class_name
    elif dataset == 'crop_plant_db':
      self.names = crop_class_name
    elif dataset == 'stem_plant_db':
      self.names = stem_class_name
...
plant_class_name = ["bean", "bean_stem", "leek", "leek_stem", "maize", "maize_stem"]
crop_class_name = ["bean", "leek", "maize"]
stem_class_name = ["bean_stem", "leek_stem", "maize_stem"]
